...
public class Then extends ForthWordBase {
	public Then() {
		super("THEN", "Used in a colon-definition in the form: IF ... ELSE ... THEN or IF ... THEN. THEN is the point where execution resumes after ELSE or IF (when no ELSE is present).", true);
	}
	@Override
